...
export default function MarkInactiveDriver({ driverId }: { driverId: string }) {
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="sm:max-w-md">
        <AlertDialogHeader>
          <AlertDialogTitle>Mark driver as inactive</AlertDialogTitle>
          <AlertDialogDescription>
            This will remove the driver from active assignments and prevent them
            from accepting new orders. You must provide a reason for this
            action.
          </AlertDialogDescription>
        </AlertDialogHeader>
