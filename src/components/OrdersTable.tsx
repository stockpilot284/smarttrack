...
export default function OrdersTable({
  ...
  const columns = useMemo<ColumnDef<OrderTable>[]>(() => {
    ...
    cols.push(
      ...
      { header: 'Drop-off', accessorKey: 'dropOffLocation' },
    )
          ...
          return (
            <Popover>
              ...
              <PopoverContent className="w-fit shadow border border-border/30 rounded-sm flex flex-col p-1.5">
                <Link
                  className="w-full text-xs flex items-center gap-2 text-muted-foreground hover:text-foreground transition hover:bg-gray-50 py-2 px-1.5 font-medium rounded-md cursor-pointer"
